...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400 text-sm font-medium leading-5 whiteAmaso focus:outline-none focus:border-whiteAmaso transition duration-150 ease-in-out'
